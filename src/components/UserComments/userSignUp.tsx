...
import { Input, UncontrolledCollapse, CardBody, Card, Button, FormGroup, FormFeedback } from 'react-bootstrap'
        ...
        <FormGroup>
          ...
          <div className="row comment-box">
            ...
            <div className="col-lg-3 col-md-3">
              <Button color="primary" disabled={!valid} onClick={onSignUp}>
                SignUp
              </Button>
            </div>
          </div>
