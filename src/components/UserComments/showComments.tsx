                        ...
                        {comment.respondTo == null ? <>
                            <div className='row'>
                                ...
                                <div className='col-lg-10 col-sm-10' >
                                    ...
                                    <div style={{ display: 'flex' }} >
                                        {time.days > 0 ? (<Label>{time.days}d</Label>) :
                                            <>{time.hours > 0 ? (<Label for=" ">{time.hours}h</Label>) :
                                        ...
                                        {isLogIn ? <>
                                            {user.id !== comment.userId ?
                                                <Label
                                                    ...
                                                    role="presentation"
                                                    onClick={() => setReplyId(comment.id)}>Reply
                                                </Label> : null}
                                        </> : null
                                        }
                                    </div>
                            ...
                            {comment.id === replyId ?
                                <div className='col-lg-10 col-md-10'>
                                    <Input className="classNamem-control"
                                        type="textarea" name="text"
                                        id="exampleText"
                                        onChange={(e) => setReplyValue(e.target.value)}
                                        value={replyValue}
                                    />
                                    <Label className='img-button' role='presentation' onClick={handleReply} >Send</Label>
                                    <p className='img-button' role='presentation' onClick={closeBox}>x</p>
                                </div>
                                : null}
                            {comment.id === index ? <>
                                <Input className="classNamem-control"
                                ...
                                />
                                <p className='img-button' role='presentation' onClick={submitUpdate}>update</p>
                                <p className='img-button' role='presentation' onClick={closeBox}>x</p>
                            </> : null}
                        </> : null}
                                    ...
                                    {response.respondTo === comment.id ? <>
                                        <div className='row'>
                                            ...
                                            <div className='col-lg-9 col-sm-9' >
                                                ...
                                                <div>
                                                    {time1.days > 0 ? (<Label>{time1.days}d</Label>) :
                                                        <>{time1.hours > 0 ? (<Label>{time1.hours}h</Label>) :
                                            ...
                                            {response.id === responseUpdateId ? <>
                                                ...
                                                />
                                                <p className='img-button' role='presentation' onClick={handleResponseUpdate}>update</p>
                                                <p className='img-button' role='presentation' onClick={closeBox}>x</p>
                                            </> : null}
                                            <hr />
                                        </div>
