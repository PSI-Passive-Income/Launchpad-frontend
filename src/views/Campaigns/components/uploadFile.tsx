...
const UploadOption: React.FC<Props> = ({ campaign }) => {
    ...
    const toggleLink = () => { setIsOpenLink(!isOpenLink); }
        ...
        <div className="card">
            <div className="card-body">
                <div style={{ display: 'flex', justifyContent: 'space-between' }}>
                    <Button color="primary" onClick={toggleFile} style={{ marginBottom: '1rem' }}>Upload Audit File</Button>
                    <Button color="primary" onClick={toggleLink} style={{ marginBottom: '1rem' }}>Upload Social Media Link</Button>
                </div>
                <div className="row">
