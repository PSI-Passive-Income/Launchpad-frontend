...
export const userSignUpEmail = (signUp: signUpDataInfo) => async (dispatch: AppDispatch, getState: () => RootState) => {
...
export const getComments = (campaignId: string) => async (dispatch: AppDispatch, getState: () => RootState) => {
  try {
...
export const getUpdateComment =
  (data: { id: number; comment: string }, campaignId: string) =>
