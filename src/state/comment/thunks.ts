...
import { userLogIn, userLogOut, loadComments, loadupdateComment, deleteComment } from '.'

export const userSignUpEmail = (signUp: signUpDataInfo) => async (dispatch: AppDispatch) => {
...
export const logInEmail = (login?: Partial<loginDataInfo>) => async (dispatch: AppDispatch) => {
...
export const getComments = (campaignId: string) => async (dispatch: AppDispatch) => {
  try {
...
export const getUpdateComment =
  (data: { id: number; comment: string }, campaignId: string) => async (dispatch: AppDispatch) => {
    try {
...
export const removeComment = (campaignId: string, id: number) => async (dispatch: AppDispatch) => {
  try {
    await deleteCommentApi(campaignId, id)
